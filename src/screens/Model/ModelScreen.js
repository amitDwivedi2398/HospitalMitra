...
import { View, StyleSheet, Modal, TouchableOpacity, TouchableWithoutFeedback, Image, Text, TextInput } from 'react-native';
            ...
            >
                <TouchableOpacity onPress={modelClose} style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }} >
                    <TouchableWithoutFeedback>
                        <View style={{ height: '45%', width: '90%', backgroundColor: 'white',borderRadius:20 }} >
                        <Text style={styles.hospitalName} > HOSPITAL NAME : {name}</Text>
                            <CustomRatingBar />
                            <Text style={styles.textStyle} >{defaultRating +'/'+ maxRating.length}</Text>
                            <TextInput
                            style={[styles.inputStyle,{height:100,paddingVertical:10,textAlignVertical:'top'}]}
                            multiline={true}
